...
if __name__ == '__main__':
    ...
    cnt = {
        2:
        Gene(node_dict_lite[0].affordance['box_aff_pz'],
    ...
    best = genetic_programming(node_dict_lite=node_dict_lite,
    ...
    print('Finished optimization in {:.4f} seconds. Cost: {}; CNT_SAT: {} '.
          format(end - start, cost, cnt_sat))
    g.create_scene()
