...
def objective_parent_child_stability(arr, object_pose_dict, sg: Graph):
    ...
    # print(cost_[0][0], step_direction)
...
def objective_collision(arr, object_pose_dict, sg: Graph):
    ...
    # _, distance_data = sg.collision_manager.min_distance_internal(return_names=True, return_data=True)
    ...
    for contact_data in contacts:
        ...
        # print(collision_pair[0], collision_pair[1], contact_data.depth)
        ...
        # collision_cost += WEIGHT_COLLISION * (contact_data.depth / SAFE_MARGIN_COLLISION + 1)

    # collision_cost += WEIGHT_COLLISION * (np.sum(list(max_penetration_dict.values())) / SAFE_MARGIN_COLLISION + 1)
    # if distance_data.distance > 0 and distance_data.distance < SAFE_MARGIN_COLLISION:
    #     distance_pair = list(map(int, distance_data.names))
    #     print(distance_pair[0], distance_pair[1], distance_data.distance)
    #     if distance_pair[0] in max_penetration_dict.keys() and distance_pair[1] in max_penetration_dict.keys() and \
    #         (distance_pair[1] not in max_penetration_dict[distance_pair[0]].keys() or \
    #         max_penetration_dict[distance_pair[0]][distance_pair[1]] < distance_data.distance):
    #         max_penetration_dict[distance_pair[0]][distance_pair[1]] = distance_data.distance

    #     if distance_pair[1] in max_penetration_dict.keys() and distance_pair[0] in max_penetration_dict.keys() and \
    #         (distance_pair[0] not in max_penetration_dict[distance_pair[1]].keys() or \
    #         max_penetration_dict[distance_pair[1]][distance_pair[0]] < distance_data.distance):
    #         max_penetration_dict[distance_pair[1]][distance_pair[0]] = distance_data.distance

    #     distance_cost += WEIGHT_COLLISION * -(distance_data.distance / SAFE_MARGIN_COLLISION) + 1

    # print(max_penetration_dict)
    # input()
    ...
    # return distance_cost + collision_cost, step_direction
