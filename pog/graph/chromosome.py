...
class Chromosome():
    ...
    # def addConstraints(self, name, value):
    #     self.height_cnt = value if name == 'height' else self.height_cnt # float
    #     self.gene_cnt = value if name == 'gene' else self.gene_cnt # partial chromo
    #     self.prop_cnt = value if name == 'propagation' else self.prop_cnt # edge child-parent
    #     self.fixed_nodes = value if name == 'fixed' else self.fixed_nodes # nodes that fixed wrt their parents
...
if __name__ == '__main__':
    ...
    print(
        nx.algorithms.similarity.graph_edit_distance(chromo1.chromograph,
                                                     chromo2.chromograph,
                                                     node_match=match,
                                                     edge_match=match,
                                                     roots=(0, 0)))
