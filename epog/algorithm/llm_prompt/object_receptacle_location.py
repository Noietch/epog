...
def get_most_likely_receptacle(object_category: str, room: str, receptcle: list[str]) -> ObjectReceptacleLocation:
...
if __name__ == "__main__":
    print(get_most_likely_receptacle("apple", 'kitchen', ['fridge', 'dinningtable']))